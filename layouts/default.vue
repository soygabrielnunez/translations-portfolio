...
<div class="grid justify-center app-container">
  <header class="p-6 md:p-8 dark:text-gray-50 text-3xl sm:text-5xl font-semibold flex items-center justify-between">
    <div class="flex items-center">
      ...
      /></nuxt-link>&nbsp;
      <nuxt-link to="/"><span class="ml-1">Julio<span class="text-purple-600 dark:text-purple-400"> Colmenares</span></span></nuxt-link>
    </div>
    <button
  ...
  <footer class="dark:text-gray-50 p-6 text-lg">
    <div>
      ...
      <span class="hidden lg:inline">Follow me: </span><a href="https://twitter.com/Bango_the_Go/" target="_blank" class="font-bold cursor-pointer">@Bango_the_Go</a>
      <br />
